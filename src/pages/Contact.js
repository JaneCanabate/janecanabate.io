                            ...
                            <Row lg={1}>
                                <Col className="m-auto border-bottom border-primary border-2 py-lg-4">
                                    ...
                                    <div className='text-center '>
                                        <a href='link' ><i class="fs-1 px-3 bi bi-github text-primary"></i></a>
                                        <a href='link' ><i class="fs-1 px-3 bi bi-instagram text-primary"></i></a>
                                        <a href='link' ><i class="fs-1 px-3 bi bi-google text-primary"></i></a>
                                        <a href='link' ><i class="fs-1 px-3 bi bi-facebook text-primary"></i></a>
                                    </div>
                                </Col>
                                ...
                                <Col className=" border-top border-primary border-2">
                                    ...
                                    <div className="text-center">
                                    <i class="fs-4 px-3 bi bi-telephone text-primary"> +6300000000</i>
                                    </div>
                                </Col>
                            </Row>
                        </Card>
